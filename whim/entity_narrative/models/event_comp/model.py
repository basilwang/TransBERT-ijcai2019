...
from whim.entity_narrative import ArgumentCompositionNarrativeChainModel, \
    build_id2word
from whim.entity_narrative import EventCompositionShell
from whim.entity_narrative import CoherenceScorer
from whim.entity_narrative import NarrativeChainModel
from whim.entity_narrative import VectorSpaceNarrativeChainModel
...
Event pair composition:     %d layers ([%d|%d]->%s->1)""" % (
    ...
    def get_nearest_neighbour_finder(self, model_name, port):
        if self._nearest_neighbour_finder is None:
            from whim.entity_narrative import NearestNeighbourFinder
            # Cache once loaded
